          ...
          <div className="row align-items-center">
            <div className="col-lg-6">
              <div className="slider-content">
                <div className="sub-title mb-20">{t("wtsrg")}</div>
                <h1
                  style={
                    {
                ...
                <div className="slider-btns mt-30">
                  <Link href="/shop-grid" passHref>
                    <a className="theme-btn w-50 text-center style-two d-flex justify-content-between align-items-center">
                      <span className="flex-grow-1 text-center">{t("op")}</span>
      ...
      >
        <div className="container">
          <div className="row align-items-center">
            ...
            <div className="col-lg-6">
              <div className="slider-content margin-mobile">
                <br />
                <div className="sub-title mb-20">{t("wtsrg")}</div>
                <h1>{t("pnfs")}</h1>
                <h6>{t("oyoe")}</h6>
                <div className="slider-btns mt-30 w-250">
                  <Link href="/shop-grid">
                    <a className="theme-btn w-50">
                      {t("op")} <i className="fas fa-angle-double-right" />
                    </a>
                  </Link>
                </div>
              </div>
      ...
      >
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-6">
              <div className="slider-content">
                <div className="sub-title mb-20">Welcome to Sun Rise Gold</div>
                <h1>Pure &amp; Natural Food Solutions</h1>
                <div className="slider-btns mt-30">
                  <Link href="/shop-grid">
